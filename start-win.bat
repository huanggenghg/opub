...
REM The first quoted string "HGSAU Backend" is the title of the new window.
REM cmd /k runs the command and keeps the window open to show logs.
START "HGSAU Backend" cmd /k "python hgsau_backend.py"

ECHO [2/2] Starting Vue.js Frontend Server in another new window...
START "HGSAU Frontend" cmd /k "cd hgsau_frontend && npm run dev -- --host 0.0.0.0"
